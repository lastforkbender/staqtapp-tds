...
def test_v3122_readme_links_api_pdf_and_english_japanese_readmes():
    ...
    pdf = root / "tds_api_docs" / "Staqtapp_TDS_v3_1_23_API_Surface_Reference.pdf"
    readme = (root / "README.md").read_text(encoding="utf-8")
    readme_ja = (root / "README_ja.md").read_text(encoding="utf-8")

    assert pdf.exists()
    assert "tds_api_docs/Staqtapp_TDS_v3_1_23_API_Surface_Reference.pdf" in readme
    assert "tds_api_docs/Staqtapp_TDS_v3_1_23_API_Surface_Reference.pdf" in readme_ja
