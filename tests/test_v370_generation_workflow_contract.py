...
def test_v370_has_one_permanent_generation_workflow_and_no_transfer_artifacts():
    ...
    assert "tests/test_v370_generation_store_hardening.py" in source
    assert "tests/test_v370_generation_process_cas.py" in source
    assert "tests/test_v370_csv_generation.py" in source
    assert "tests/test_v370_generation_audit.py" in source
    assert "staqtapp-tds-generation-audit" in source
