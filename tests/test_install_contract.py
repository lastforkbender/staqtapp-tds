...
def test_standard_install_includes_main_telemetry_ui_launcher():
    ...
    assert project["scripts"]["staqtapp-tds-eaglegate"] == "staqtapp_tds.eaglegate.console:main"
    assert project["scripts"]["staqtapp-tds-eaglegate-lab"] == (
        "staqtapp_tds.eaglegate.exactness:main"
    )
    ...
    assert project["scripts"]["staqtapp-tds-eaglegate-capture"] == (
        "staqtapp_tds.eaglegate.offline_capture:main"
    )
    ...
    assert project["scripts"]["staqtapp-tds-eaglegate-capture-produce"] == (
        "staqtapp_tds.eaglegate.capture_producer:main"
    )
    assert project["scripts"]["staqtapp-tds-eaglegate-capture-producer-lab"] == (
        "staqtapp_tds.eaglegate.capture_producer_suite:main"
    )
