...
def main() -> int:
    ...
    if closure_report.get("source_version") != expected_version:
        return fail("v3.6 Foundation Closure source version mismatch")
